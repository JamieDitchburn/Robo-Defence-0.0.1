...
public class Turret2 extends Turret {
	...
	// Animations
		...
		public Turret2(TileMap tm, LevelState ls) {
			super(tm, ls);
			...
			damage = 1;
			turretRange = 500;			// Range in pixels.
			fireRate = 4;				// How many times it fires per second.
			...
			buildAnimDelay = 800;
			upgradeCost = 100;			// Cost to upgrade to this level.
			...
			try {
				...
				BufferedImage spritesheet = ImageIO.read(getClass().getResourceAsStream("/Sprites/Turrets/turret2.gif"));
